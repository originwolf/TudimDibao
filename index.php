...
<body>
	...
	<div id="fb-root"></div>
	<!-- Script necessário ao widget do facebook -->
	...
	<div class="container-fluid">
		...
		<footer>
			...
			<section class="row justify-content-center rodape">	
				...
				<button id="arrow" type="button" onclick="go('#home')" class="btn btn-outline-light"><i class="fas fa-arrow-up"></i></button>
	...
	<script>
		$('#slideshow').carousel({interval: 3500, pause: false});
	</script>
